...
def calculate_af(coverage_dir, concat_dir, AF_F, ref_fasta, maxBP, topN=500, min_cells=100, min_reads=100, coverage_thresh=-1, het_thresh=0, min_het_cells=0, num_proc=8):
    """
