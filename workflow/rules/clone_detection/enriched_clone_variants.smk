...
rule counts_clones:
    ...
    output:
        multiext("{outdir}/enriched_barcodes/objs_{wt}/clones/variants_{variants}/knn/kparam_{kparam}/annotation_clones/clone_counts/",
                 "clone_counts.barplot_conditions.png",
                 ),
        note = "{outdir}/enriched_barcodes/objs_{wt}/clones/variants_{variants}/knn/kparam_{kparam}/annotation_clones/clone_counts/counts_clones.ipynb"
    params:
        outdir = lambda wildcards, output: dirname(output.note),
...
rule finalize:
    input:
        ...
        expand("{{outdir}}/enriched_barcodes/objs_{wt}/clones/variants_{variants}/knn/kparam_{kparam}/annotation_clones/clone_counts/counts_clones.ipynb",
               variants=[x for x in params_clones["variants"] if x != "simple"],
               kparam=params_clones["knn"]["params"]["resolution"],
               wt = weights_ids)
