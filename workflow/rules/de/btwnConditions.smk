...
def get_btwnCond_rscript(wildcards):
    if wildcards.assay == "RNA":
        return join(ROOT_DIR, "workflow/notebooks/nuclear_de/de_conditions/DE_genes_btwnConds.ipynb")
    else:
        return join(ROOT_DIR, "workflow/notebooks/nuclear_de/de_conditions/DE_peaks_btwnConds.ipynb")
    return
...
rule btwnCond_DE:
    ...
    params:
        rscript= join(ROOT_DIR, "workflow/notebooks/nuclear_de/de_conditions/DE_genes_btwnConditions.ipynb"), # The script defaults to the granja data
...
rule runGSEA_btwnCond:
    ...
    params:
        ...
        rscript = join(ROOT_DIR, "workflow/notebooks/nuclear_de/de_conditions/runGSEA_btwnCond.ipynb"),
